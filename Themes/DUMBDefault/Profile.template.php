	...
	echo '
		<div class="alert_bar">
			<div class="alerts_opts block">
				...
				<a href="' . $scripturl . '?action=profile;area=notification;sa=markread;', $context['session_var'], '=', $context['session_id'], '" onclick="return markAlertsRead(this)" class="button floatright">', $txt['mark_alerts_read'], '</a>
			</div>
